...
- 通过命令和原生编辑器右键菜单提供格式化、合并、拆分、设置表头、插入和检查能力。
- 无效结构只提示，不改写笔记。
...
设置页沿用 Obsidian 原生控件，分为“常规”“视图”和“外观”三个页签。表格布局可选择“适应内容宽度—靠左”“适应内容宽度—居中”或“适应窗格宽度”；还可控制阅读视图、实时预览、诊断、舒适/紧凑密度、交替行底色，以及跟随 Obsidian/英文/简体中文界面语言。
