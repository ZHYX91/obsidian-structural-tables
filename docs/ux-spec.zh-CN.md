...
使用 Obsidian 原生设置控件和顶部分页，分为“常规”“视图”“外观”。语言位于第一个“常规”页，自动语言显示为“跟随 Obsidian”并附带说明。“外观”提供“适应内容宽度—靠左”“适应内容宽度—居中”和“适应窗格宽度”三种表格布局；布局只改变整个表格的位置和宽度，不改变单元格内容对齐。控件标签与说明支持英文和简体中文。
